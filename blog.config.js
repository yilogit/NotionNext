...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yiloko', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在读高中生📓', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yuloko.asia', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2900502480@qq.com.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      ...
      artist: 'Mili',
      url: 'http://music.163.com/song/media/outer/url?id=2140326577.mp3',
      cover:
        'http://p1.music.126.net/KSXSSlJ8X3s-xoanyUh1vQ==/109951169450670014.jpg'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '2092785215', // 对应歌单的 id
